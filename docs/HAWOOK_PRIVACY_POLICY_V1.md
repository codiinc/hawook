# HAWOOK PRIVACY POLICY — DRAFT v1

**Purpose:** Source content for `/privacy` on app.hawook.com.
**Status:** Draft v1 — non-legal baseline. Must be reviewed by a Thai lawyer before public publication on a live brokerage site handling buyer data.
...
Hawook ([entity name to be inserted — e.g., "Hawook Co., Ltd." or the registered Thai entity]) operates app.hawook.com and hawook.com (together, "the Hawook platform"). This Privacy Policy explains what personal information we collect, how we use it, who we share it with, and the rights you have over your data.
...
Postal: [Thai-registered business address to be inserted]

Data Protection Officer (DPO): [to be confirmed — Codi or designated team member]
